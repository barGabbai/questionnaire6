...
var Carousel = function ($$$1) {
  ...
  var Selector = {
    ...
    ITEM: '.carousel-item',
    NEXT_PREV: '.carousel-item-prev, .carousel-item-next',
  ...
  function () {
    ...
    _proto.cycle = function cycle(event) {
      ...
      if (this._config.interval && !this._isPaused) {
        this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.prev).bind(this), this._config.interval);
      }
    };
    ...
    _proto.to = function to(index) {
      ...
      var direction = index > activeIndex ? Direction.PREV : Direction.NEXT;
    ...
    _proto._getItemByDirection = function _getItemByDirection(direction, activeElement) {
      var isNextDirection = direction === Direction.PREV;
      var isPrevDirection = direction === Direction.NEXT;
      ...
      var delta = direction === Direction.NEXT ? -1 : 1;
